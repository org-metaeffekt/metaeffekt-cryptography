...
- **[management/validator-test-report.md](management/validator-test-report.md)** — Test statistics for the pattern validator: 786 tests across 16 test classes covering instance validation by taxonomy, template/constraint validation, CycloneDX coverage (213 tests), SPDX coverage (169 tests), composite validation (11 tests), X.509 certificate analysis (5 tests), CMS analysis (7 tests), CBOM validation (8 tests), and CBOM generation (4 tests). Registry: 572 entries (342 algorithms + 230 composites), 13 files, 192 unique OIDs.

...
SPDM_ENTRIES = {
    ...
    # ── SPDM 1.4.0 additions (DSP0274 v1.4.0 §10.4) — PQC algorithms ──────────
    # PQC asymmetric signatures (ReqPqcAsymAlg / PqcAsymAlgo, AlgType 0x06) and
    # KEM (KEMAlg, AlgType 0x07). NIST-standardized (FIPS 203/204/205); NIST and BSI
    # both recommend. New in 1.4.0 — v1.3.0 enumerated classical algorithms only.
    "spdm:ML-DSA-44": {"subType": "spdmPqcAsym", "components": ["ML-DSA-44"],
        "description": "ML-DSA-44 (FIPS 204; SigLen 2420)",
        "nist": ("recommended", "FIPS 204"), "bsi": ("recommended", None, "§5.3.4.2"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 0 Bit 0"]},
    "spdm:ML-DSA-65": {"subType": "spdmPqcAsym", "components": ["ML-DSA-65"],
        "description": "ML-DSA-65 (FIPS 204; SigLen 3309)",
        "nist": ("recommended", "FIPS 204"), "bsi": ("recommended", None, "§5.3.4.2"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 0 Bit 1"]},
    "spdm:ML-DSA-87": {"subType": "spdmPqcAsym", "components": ["ML-DSA-87"],
        "description": "ML-DSA-87 (FIPS 204; SigLen 4627)",
        "nist": ("recommended", "FIPS 204"), "bsi": ("recommended", None, "§5.3.4.2"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 0 Bit 2"]},
    "spdm:SLH-DSA-SHA2-128s": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHA2-128s"],
        "description": "SLH-DSA-SHA2-128s (FIPS 205; SigLen 7856)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 0 Bit 3"]},
    "spdm:SLH-DSA-SHAKE-128s": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHAKE-128s"],
        "description": "SLH-DSA-SHAKE-128s (FIPS 205; SigLen 7856)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 0 Bit 4"]},
    "spdm:SLH-DSA-SHA2-128f": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHA2-128f"],
        "description": "SLH-DSA-SHA2-128f (FIPS 205; SigLen 17088)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 0 Bit 5"]},
    "spdm:SLH-DSA-SHAKE-128f": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHAKE-128f"],
        "description": "SLH-DSA-SHAKE-128f (FIPS 205; SigLen 17088)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 0 Bit 6"]},
    "spdm:SLH-DSA-SHA2-192s": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHA2-192s"],
        "description": "SLH-DSA-SHA2-192s (FIPS 205; SigLen 16224)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 0 Bit 7"]},
    "spdm:SLH-DSA-SHAKE-192s": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHAKE-192s"],
        "description": "SLH-DSA-SHAKE-192s (FIPS 205; SigLen 16224)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 1 Bit 0"]},
    "spdm:SLH-DSA-SHA2-192f": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHA2-192f"],
        "description": "SLH-DSA-SHA2-192f (FIPS 205; SigLen 35664)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 1 Bit 1"]},
    "spdm:SLH-DSA-SHAKE-192f": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHAKE-192f"],
        "description": "SLH-DSA-SHAKE-192f (FIPS 205; SigLen 35664)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 1 Bit 2"]},
    "spdm:SLH-DSA-SHA2-256s": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHA2-256s"],
        "description": "SLH-DSA-SHA2-256s (FIPS 205; SigLen 29792)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 1 Bit 3"]},
    "spdm:SLH-DSA-SHAKE-256s": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHAKE-256s"],
        "description": "SLH-DSA-SHAKE-256s (FIPS 205; SigLen 29792)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 1 Bit 4"]},
    "spdm:SLH-DSA-SHA2-256f": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHA2-256f"],
        "description": "SLH-DSA-SHA2-256f (FIPS 205; SigLen 49856)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 1 Bit 5"]},
    "spdm:SLH-DSA-SHAKE-256f": {"subType": "spdmPqcAsym", "components": ["SLH-DSA-SHAKE-256f"],
        "description": "SLH-DSA-SHAKE-256f (FIPS 205; SigLen 49856)",
        "nist": ("recommended", "FIPS 205"), "bsi": ("recommended", None, "§5.3.4.1"),
        "remarks": ["DSP0274 v1.4.0 §10.4 ReqPqcAsymAlg Byte 1 Bit 6"]},
    "spdm:ML-KEM-512": {"subType": "spdmKem", "components": ["ML-KEM-512"],
        "description": "ML-KEM-512 (FIPS 203)",
        "nist": ("recommended", "FIPS 203"), "bsi": ("recommended", None, "§2.4.3"),
        "remarks": ["DSP0274 v1.4.0 §10.4 KEMAlg Byte 0 Bit 0"]},
    "spdm:ML-KEM-768": {"subType": "spdmKem", "components": ["ML-KEM-768"],
        "description": "ML-KEM-768 (FIPS 203)",
        "nist": ("recommended", "FIPS 203"), "bsi": ("recommended", None, "§2.4.3"),
        "remarks": ["DSP0274 v1.4.0 §10.4 KEMAlg Byte 1 Bit 0"]},
    "spdm:ML-KEM-1024": {"subType": "spdmKem", "components": ["ML-KEM-1024"],
        "description": "ML-KEM-1024 (FIPS 203)",
        "nist": ("recommended", "FIPS 203"), "bsi": ("recommended", None, "§2.4.3"),
        "remarks": ["DSP0274 v1.4.0 §10.4 KEMAlg Byte 2 Bit 0"]},
}
...
def generate_spdm_yaml(entries: list[dict]) -> str:
    parts = [
        ...
        "# Source of truth: DMTF DSP0274 Security Protocol and Data Model (SPDM) v1.4.0 §10.4",
